                ...
                <div class="hero__grid">
                    <div class="hero__content">
                        ...
                        <h1 class="hero__title">
                            <span>Tạo ra </span>Một văn hoá tái chế và tái sử
                            dụng, để mỗi sản phẩm được tái chế là một bước tiến
                            cho môi trường.
                        </h1>
                        <button class="order__btn">
                            <a href="/food" class="order__now"
                                >Đặt sản phẩm ngay</a
                            >
                        </button>
                    </div>
                    <div class="hero__img">
                        <img src="<%= ctx %>/assets/hero-img.png" alt="delivery-guy" />
                    </div>
                </div>
            </div>
        </section>
